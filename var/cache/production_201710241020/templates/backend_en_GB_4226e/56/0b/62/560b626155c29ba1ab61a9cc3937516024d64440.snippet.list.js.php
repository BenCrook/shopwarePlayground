<?php /* Smarty version Smarty-3.1.12, created on 2018-01-05 00:40:04
         compiled from "/Users/bencrook/Documents/my-projects/shopware/themes/Backend/ExtJs/backend/theme/controller/list.js" */ ?>
<?php /*%%SmartyHeaderCode:21318462345a4ebb547c6399-93101911%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '560b626155c29ba1ab61a9cc3937516024d64440' => 
    array (
      0 => '/Users/bencrook/Documents/my-projects/shopware/themes/Backend/ExtJs/backend/theme/controller/list.js',
      1 => 1508840484,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '21318462345a4ebb547c6399-93101911',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5a4ebb54809512_67636140',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a4ebb54809512_67636140')) {function content_5a4ebb54809512_67636140($_smarty_tpl) {?>/**
 * Shopware 5
...
');
        ...
        Ext.Ajax.request({
            url: '<?php echo '/backend/theme/assign';?>',
            method: 'POST',
            params: {
                shopId: shop.get('id'),
...
',
    ...
    onPreviewTheme: function () {
        var me = this, shop, theme,
            url = '<?php echo '/backend/theme/preview';?>';
...
');
            ...
            Ext.Ajax.request({
                url: '<?php echo '/backend/theme/resetPreviewSession';?>',
                method: 'POST',
                params: {
                    shopId: shop.get('id')
                }
