<?php /* Smarty version Smarty-3.1.12, created on 2018-01-05 00:40:18
         compiled from "/Users/bencrook/Documents/my-projects/shopware/themes/Frontend/Bare/widgets/checkout/info.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10286965885a4ebb62695487-34969490%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ba47f1e370f4409c0cde3e6b4be7b13314d47c8d' => 
    array (
      0 => '/Users/bencrook/Documents/my-projects/shopware/themes/Frontend/Bare/widgets/checkout/info.tpl',
      1 => 1508840484,
      2 => 'file',
    ),
    '8e6e8db592dd8beeb495721c6c03a3b78dc4deae' => 
    array (
      0 => '/Users/bencrook/Documents/my-projects/shopware/themes/Frontend/Bare/frontend/account/sidebar.tpl',
      1 => 1508840484,
      2 => 'snippet',
    ),
  ),
  'nocache_hash' => '10286965885a4ebb62695487-34969490',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a4ebb6281df15_24402106',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a4ebb6281df15_24402106')) {function content_5a4ebb6281df15_24402106($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_currency')) include '/Users/bencrook/Documents/my-projects/shopware/engine/Library/Enlight/Template/Plugins/modifier.currency.php';
?>

    <li class="navigation--entry entry--notepad" role="menuitem">
        <a href="<?php echo 'http://localhost:8888/note';?>" title="<?php ob_start();?><?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('namespace'=>'widgets/checkout/info','name'=>'IndexLinkNotepad')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('namespace'=>'widgets/checkout/info','name'=>'IndexLinkNotepad'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
" class="btn">
    ...
    <li class="navigation--entry entry--account<?php ob_start();?><?php echo true;?><?php $_tmp2=ob_get_clean();?><?php if ($_tmp2){?> with-slt<?php }?>"
        ...
        data-offCanvasSelector=".account--dropdown-navigation">
            ...
            <a href="<?php echo 'http://localhost:8888/account';?>"
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("frontend/account/sidebar.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('showSidebar'=>true,'inHeader'=>true), 0, '10286965885a4ebb62695487-34969490');
content_5a4ebb62703b69_39694275($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /*  End of included template "frontend/account/sidebar.tpl" */?>
    ...
    <li class="navigation--entry entry--cart" role="menuitem">
        <a class="btn is--icon-left cart--link" href="<?php echo 'http://localhost:8888/checkout/cart';?>" title="<?php ob_start();?><?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('namespace'=>'widgets/checkout/info','name'=>'IndexLinkCart')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('namespace'=>'widgets/checkout/info','name'=>'IndexLinkCart'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
<?php }} ?><?php /* Smarty version Smarty-3.1.12, created on 2018-01-05 00:40:18
         compiled from "/Users/bencrook/Documents/my-projects/shopware/themes/Frontend/Bare/frontend/account/sidebar.tpl" */ ?>
<?php if ($_valid && !is_callable('content_5a4ebb62703b69_39694275')) {function content_5a4ebb62703b69_39694275($_smarty_tpl) {?><?php if (!is_callable('smarty_function_controllerName')) include '/Users/bencrook/Documents/my-projects/shopware/engine/Library/Enlight/Template/Plugins/function.controllerName.php';
                    ...
                    <ul class="sidebar--navigation navigation--list is--level0 show--active-items">
                                ...
                                <?php ob_start();?><?php echo true;?><?php $_tmp3=ob_get_clean();?><?php if ($_tmp3&&!$_smarty_tpl->tpl_vars['userInfo']->value&&$_smarty_tpl->tpl_vars['inHeader']->value){?>
                                    ...
                                    <span class="navigation--signin">
                                        <a href="<?php echo 'http://localhost:8888/account';?>#hide-registration"
...
or<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"AccountOr",'namespace'=>'frontend/account/sidebar'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
                                            ...
                                            <a href="<?php echo 'http://localhost:8888/account';?>#show-registration"
...
register<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"AccountRegister",'namespace'=>'frontend/account/sidebar'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
                                ...
                                <li class="navigation--entry">
                                    <a href="<?php echo 'http://localhost:8888/account';?>" title="<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"AccountLinkOverview",'namespace'=>'frontend/account/sidebar')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"AccountLinkOverview",'namespace'=>'frontend/account/sidebar'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
Addresses<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"AccountLinkAddresses",'namespace'=>'frontend/account/sidebar'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
                                ...
                                <?php }else{ ?>
                                    <li class="navigation--entry">
                                        <a href="<?php echo 'http://localhost:8888/address';?>" title="<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"AccountLinkAddresses",'default'=>'My addresses','namespace'=>'frontend/account/sidebar')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"AccountLinkAddresses",'default'=>'My addresses','namespace'=>'frontend/account/sidebar'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
Addresses<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"AccountLinkAddresses",'default'=>'My addresses','namespace'=>'frontend/account/sidebar'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
                                ...
                                <li class="navigation--entry">
                                    <a href="<?php echo 'http://localhost:8888/account/payment';?>" title="<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"AccountLinkPayment",'namespace'=>'frontend/account/sidebar')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"AccountLinkPayment",'namespace'=>'frontend/account/sidebar'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
Payment methods<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"AccountLinkPayment",'namespace'=>'frontend/account/sidebar'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
                                ...
                                <li class="navigation--entry">
                                    <a href="<?php echo 'http://localhost:8888/account/orders';?>" title="<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"AccountLinkPreviousOrders",'namespace'=>'frontend/account/sidebar')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"AccountLinkPreviousOrders",'namespace'=>'frontend/account/sidebar'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
Instant downloads<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"AccountLinkDownloads",'namespace'=>'frontend/account/sidebar'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
                                ...
                                <li class="navigation--entry">
                                    <a href="<?php echo 'http://localhost:8888/note';?>" title="<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"AccountLinkNotepad",'namespace'=>'frontend/account/sidebar')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"AccountLinkNotepad",'namespace'=>'frontend/account/sidebar'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
Wish list<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"AccountLinkNotepad",'namespace'=>'frontend/account/sidebar'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
                                ...
                                <?php ob_start();?><?php echo true;?><?php $_tmp10=ob_get_clean();?><?php if ($_tmp10&&$_smarty_tpl->tpl_vars['userInfo']->value){?>
                                    <li class="navigation--entry">
                                            ...
                                            <a href="<?php echo 'http://localhost:8888/account/logout';?>" title="<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"AccountLogout",'namespace'=>'frontend/account/sidebar')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"AccountLogout",'namespace'=>'frontend/account/sidebar'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
Logout<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"AccountLogout",'namespace'=>'frontend/account/sidebar'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
                                ...
                                <?php }elseif($_smarty_tpl->tpl_vars['sUserLoggedIn']->value&&!$_smarty_tpl->tpl_vars['sOneTimeAccount']->value){?>
                                        ...
                                        <li class="navigation--entry">
                                                ...
                                                <a href="<?php echo 'http://localhost:8888/account/logout';?>" title="<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"AccountLinkLogout2",'namespace'=>'frontend/account/sidebar')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"AccountLinkLogout2",'namespace'=>'frontend/account/sidebar'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
