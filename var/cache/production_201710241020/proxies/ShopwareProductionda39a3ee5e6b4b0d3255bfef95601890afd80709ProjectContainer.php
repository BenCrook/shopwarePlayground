...
class ShopwareProductionda39a3ee5e6b4b0d3255bfef95601890afd80709ProjectContainer extends Shopware\Components\DependencyInjection\Container
{
    ...
    {
        return $this->services['cache'] = $this->get('cache_factory')->factory('auto', array('automatic_serialization' => true, 'automatic_cleaning_factor' => 0, 'lifetime' => 3600, 'cache_id_prefix' => '3c2c402d40b1c2259e7403c4645ccc4d'), array('hashed_directory_perm' => 493, 'cache_file_perm' => 420, 'hashed_directory_level' => 3, 'cache_dir' => '/Users/bencrook/Documents/my-projects/shopware/var/cache/production_201710241020/general', 'file_name_prefix' => 'shopware'));
    }
    ...
    {
        return $this->services['db'] = \Shopware\Components\DependencyInjection\Bridge\Db::createEnlightDbAdapter($this->get('dbal_connection'), array('username' => 'ben', 'password' => 'shopware', 'dbname' => 'shopware_playground', 'host' => 'localhost', 'charset' => 'utf8mb4', 'adapter' => 'pdo_mysql', 'port' => '3306'));
    }
    ...
    {
        return $this->services['dbal_connection'] = \Shopware\Components\DependencyInjection\Bridge\Db::createDbalConnection(array('username' => 'ben', 'password' => 'shopware', 'dbname' => 'shopware_playground', 'host' => 'localhost', 'charset' => 'utf8mb4', 'adapter' => 'pdo_mysql', 'port' => '3306'), $this->get('modelconfig'), $this->get('model_event_manager'), $this->get('db_connection'));
    }
    ...
    {
        return $this->services['hooks'] = new \Enlight_Hook_HookManager($this->get('events'), $this->get('loader'), array('proxyDir' => '/Users/bencrook/Documents/my-projects/shopware/var/cache/production_201710241020/proxies', 'proxyNamespace' => 'Shopware_Proxies'));
    }
    ...
    {
        return $this->services['modelannotations'] = $this->get('model_annotations_factory')->factory($this->get('modelconfig'), '/Users/bencrook/Documents/my-projects/shopware/engine/Shopware/Models');
    }
    protected function getModelconfigService()
    {
        return $this->services['modelconfig'] = new \Shopware\Components\Model\Configuration(array('autoGenerateProxyClasses' => false, 'attributeDir' => '/Users/bencrook/Documents/my-projects/shopware/var/cache/production_201710241020/doctrine/attributes', 'proxyDir' => '/Users/bencrook/Documents/my-projects/shopware/var/cache/production_201710241020/doctrine/proxies', 'proxyNamespace' => 'Shopware\\Proxies', 'cacheProvider' => 'auto', 'cacheNamespace' => NULL), $this->get('cache'), new \Shopware\Components\Model\ProxyAwareRepositoryFactory($this->get('hooks')));
    }
    ...
    {
        $a = new \Monolog\Handler\RotatingFileHandler('/Users/bencrook/Documents/my-projects/shopware/var/log/core_production.log', 14);
    ...
    {
        $a = new \Monolog\Handler\RotatingFileHandler('/Users/bencrook/Documents/my-projects/shopware/var/log/plugin_production.log', 14);
        $a->pushProcessor($this->get('monolog.processor.uid'));
    ...
    {
        return $this->services['plugins'] = $this->get('plugins_factory')->factory($this, $this->get('loader'), $this->get('events'), $this->get('application'), array('Default' => '/Users/bencrook/Documents/my-projects/shopware/engine/Shopware/Plugins/Default/', 'Local' => '/Users/bencrook/Documents/my-projects/shopware/engine/Shopware/Plugins/Local/', 'Community' => '/Users/bencrook/Documents/my-projects/shopware/engine/Shopware/Plugins/Community/', 'ShopwarePlugins' => '/Users/bencrook/Documents/my-projects/shopware/custom/plugins/'));
    }
    ...
    {
        return $this->services['shopware.openssl_verificator'] = new \Shopware\Components\OpenSSLVerifier('/Users/bencrook/Documents/my-projects/shopware/engine/Shopware/Components/HttpClient/public.key');
    }
    ...
    {
        return $this->services['shopware.requirements'] = new \Shopware\Components\Check\Requirements('/Users/bencrook/Documents/my-projects/shopware/engine/Shopware/Components/Check/Data/System.xml', $this->get('db_connection'));
    }
    ...
    {
        return $this->services['shopware.snippet_database_handler'] = new \Shopware\Components\Snippet\DatabaseHandler($this->get('models'), $this->get('db'), '/Users/bencrook/Documents/my-projects/shopware');
    }
    protected function getShopware_SnippetQueryHandlerService()
    {
        return $this->services['shopware.snippet_query_handler'] = new \Shopware\Components\Snippet\QueryHandler('/Users/bencrook/Documents/my-projects/shopware/snippets/');
    }
    ...
    {
        return $this->services['shopware_plugininstaller.legacy_plugin_installer'] = new \Shopware\Bundle\PluginInstallerBundle\Service\LegacyPluginInstaller($this->get('models'), $this->get('plugins'), array('Default' => '/Users/bencrook/Documents/my-projects/shopware/engine/Shopware/Plugins/Default/', 'Local' => '/Users/bencrook/Documents/my-projects/shopware/engine/Shopware/Plugins/Local/', 'Community' => '/Users/bencrook/Documents/my-projects/shopware/engine/Shopware/Plugins/Community/', 'ShopwarePlugins' => '/Users/bencrook/Documents/my-projects/shopware/custom/plugins/'));
    }
    protected function getShopwarePlugininstaller_PluginDownloadServiceService()
    {
        return $this->services['shopware_plugininstaller.plugin_download_service'] = new \Shopware\Bundle\PluginInstallerBundle\Service\DownloadService('/Users/bencrook/Documents/my-projects/shopware', array('Default' => '/Users/bencrook/Documents/my-projects/shopware/engine/Shopware/Plugins/Default/', 'Local' => '/Users/bencrook/Documents/my-projects/shopware/engine/Shopware/Plugins/Local/', 'Community' => '/Users/bencrook/Documents/my-projects/shopware/engine/Shopware/Plugins/Community/', 'ShopwarePlugins' => '/Users/bencrook/Documents/my-projects/shopware/custom/plugins/'), $this->get('shopware_plugininstaller.store_client'), $this->get('dbal_connection'));
    }
    protected function getShopwarePlugininstaller_PluginInstallerService()
    {
        return $this->services['shopware_plugininstaller.plugin_installer'] = new \Shopware\Bundle\PluginInstallerBundle\Service\PluginInstaller($this->get('models'), $this->get('shopware.snippet_database_handler'), $this->get('shopware.plugin_requirement_validator'), $this->get('db_connection'), '/Users/bencrook/Documents/my-projects/shopware/custom/plugins/');
    }
    ...
    {
        return $this->services['theme_compiler'] = new \Shopware\Components\Theme\Compiler('/Users/bencrook/Documents/my-projects/shopware', $this->get('oyejorge_compiler'), $this->get('theme_path_resolver'), $this->get('theme_inheritance'), $this->get('theme_service'), $this->get('js_compressor'), $this->get('events'), $this->get('theme_timestamp_persistor'));
    }
    ...
    {
        return $this->services['theme_path_resolver'] = new \Shopware\Components\Theme\PathResolver('/Users/bencrook/Documents/my-projects/shopware', array('Default' => '/Users/bencrook/Documents/my-projects/shopware/engine/Shopware/Plugins/Default/', 'Local' => '/Users/bencrook/Documents/my-projects/shopware/engine/Shopware/Plugins/Local/', 'Community' => '/Users/bencrook/Documents/my-projects/shopware/engine/Shopware/Plugins/Community/', 'ShopwarePlugins' => '/Users/bencrook/Documents/my-projects/shopware/custom/plugins/'), $this->get('template'));
    }
    ...
    {
        return $this->services['thumbnail_manager'] = new \Shopware\Components\Thumbnail\Manager($this->get('thumbnail_generator_basic'), '/Users/bencrook/Documents/my-projects/shopware', $this->get('events'), $this->get('shopware_media.media_service'));
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/Users/bencrook/Documents/my-projects/shopware',
            'kernel.environment' => 'production',
            'kernel.debug' => false,
            'kernel.name' => 'Shopware',
            'kernel.cache_dir' => '/Users/bencrook/Documents/my-projects/shopware/var/cache/production_201710241020',
            'kernel.logs_dir' => '/Users/bencrook/Documents/my-projects/shopware/var/log',
            ...
            'shopware.cdn' => array(
                ...
                'adapters' => array(
                    'local' => array(
                        ...
                        'path' => '/Users/bencrook/Documents/my-projects/shopware',
                    ),
                    'ftp' => array(
                        'type' => 'ftp',
                        'mediaUrl' => '',
            ...
            'shopware.cdn.adapters.local.path' => '/Users/bencrook/Documents/my-projects/shopware',
            ...
            'shopware.db' => array(
                'username' => 'ben',
                'password' => 'shopware',
                'dbname' => 'shopware_playground',
                'host' => 'localhost',
                'charset' => 'utf8mb4',
                'adapter' => 'pdo_mysql',
                'port' => '3306',
            ),
            'shopware.db.username' => 'ben',
            'shopware.db.password' => 'shopware',
            'shopware.db.dbname' => 'shopware_playground',
            ...
            'shopware.plugin_directories' => array(
                'Default' => '/Users/bencrook/Documents/my-projects/shopware/engine/Shopware/Plugins/Default/',
                'Local' => '/Users/bencrook/Documents/my-projects/shopware/engine/Shopware/Plugins/Local/',
                'Community' => '/Users/bencrook/Documents/my-projects/shopware/engine/Shopware/Plugins/Community/',
                'ShopwarePlugins' => '/Users/bencrook/Documents/my-projects/shopware/custom/plugins/',
            ),
            'shopware.plugin_directories.default' => '/Users/bencrook/Documents/my-projects/shopware/engine/Shopware/Plugins/Default/',
            'shopware.plugin_directories.local' => '/Users/bencrook/Documents/my-projects/shopware/engine/Shopware/Plugins/Local/',
            'shopware.plugin_directories.community' => '/Users/bencrook/Documents/my-projects/shopware/engine/Shopware/Plugins/Community/',
            'shopware.plugin_directories.shopwareplugins' => '/Users/bencrook/Documents/my-projects/shopware/custom/plugins/',
            'shopware.template' => array(
                ...
                'charset' => 'utf-8',
                'forceCache' => false,
                'cacheDir' => '/Users/bencrook/Documents/my-projects/shopware/var/cache/production_201710241020/templates',
                'compileDir' => '/Users/bencrook/Documents/my-projects/shopware/var/cache/production_201710241020/templates',
            ),
            ...
            'shopware.template.cachedir' => '/Users/bencrook/Documents/my-projects/shopware/var/cache/production_201710241020/templates',
            'shopware.template.compiledir' => '/Users/bencrook/Documents/my-projects/shopware/var/cache/production_201710241020/templates',
            'shopware.mail' => array(
                'charset' => 'utf-8',
            ),
            ...
            'shopware.httpcache' => array(
                ...
                'cache_dir' => '/Users/bencrook/Documents/my-projects/shopware/var/cache/production_201710241020/html',
                'cache_cookies' => array(
                    0 => 'shop',
                    1 => 'currency',
            ...
            'shopware.httpcache.cache_dir' => '/Users/bencrook/Documents/my-projects/shopware/var/cache/production_201710241020/html',
            ...
            'shopware.cache' => array(
                'frontendOptions' => array(
                    ...
                    'lifetime' => 3600,
                    'cache_id_prefix' => '3c2c402d40b1c2259e7403c4645ccc4d',
                ),
                'backend' => 'auto',
                'backendOptions' => array(
                    ...
                    'cache_dir' => '/Users/bencrook/Documents/my-projects/shopware/var/cache/production_201710241020/general',
            ...
            'shopware.cache.frontendoptions.cache_id_prefix' => '3c2c402d40b1c2259e7403c4645ccc4d',
            ...
            'shopware.cache.backendoptions.cache_dir' => '/Users/bencrook/Documents/my-projects/shopware/var/cache/production_201710241020/general',
            'shopware.cache.backendoptions.file_name_prefix' => 'shopware',
            'shopware.hook' => array(
                'proxyDir' => '/Users/bencrook/Documents/my-projects/shopware/var/cache/production_201710241020/proxies',
                'proxyNamespace' => 'Shopware_Proxies',
            ),
            'shopware.hook.proxydir' => '/Users/bencrook/Documents/my-projects/shopware/var/cache/production_201710241020/proxies',
            'shopware.hook.proxynamespace' => 'Shopware_Proxies',
            'shopware.model' => array(
                'autoGenerateProxyClasses' => false,
                'attributeDir' => '/Users/bencrook/Documents/my-projects/shopware/var/cache/production_201710241020/doctrine/attributes',
                'proxyDir' => '/Users/bencrook/Documents/my-projects/shopware/var/cache/production_201710241020/doctrine/proxies',
                'proxyNamespace' => 'Shopware\\Proxies',
                'cacheProvider' => 'auto',
                'cacheNamespace' => NULL,
            ),
            'shopware.model.autogenerateproxyclasses' => false,
            'shopware.model.attributedir' => '/Users/bencrook/Documents/my-projects/shopware/var/cache/production_201710241020/doctrine/attributes',
            'shopware.model.proxydir' => '/Users/bencrook/Documents/my-projects/shopware/var/cache/production_201710241020/doctrine/proxies',
